 ...
 *
 * Shot at device scale 1 rather than the 2x used for design review: a README image has to
 * stay under about 500KB so the page loads on bad wifi, and 1440px wide at 1x is still
...
await page.screenshot({ path: resolve(OUTPUT_DIR, "01-scene.png") });
console.log("[readmeShots] 01-scene.png");
...
await page.screenshot({ path: resolve(OUTPUT_DIR, "02-write.png") });
console.log("[readmeShots] 02-write.png");
...
await page.waitForTimeout(1500);
await page.screenshot({ path: resolve(OUTPUT_DIR, "03-door.png") });
console.log("[readmeShots] 03-door.png");
