...
const french = {
  ...
  write: {
    ...
    authorizeWriter: "Désigner ce portefeuille comme plume",
    authorizingWriter: "Désignation…",
...
const english: typeof french = {
  ...
  write: {
    ...
    authorizeWriter: "Have the Safe name this wallet",
    authorizingWriter: "Naming…",
